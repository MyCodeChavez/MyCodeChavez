...
- Experiencia en multi-tenant, gestión de clínicas y apps web interactivas.
- Entrego soluciones limpias, mantenibles y enfocadas en rendimiento.

## Tecnologías
<p align="left">
  <img src="https://skillicons.dev/icons?i=ts,js,react,redux,nodejs,express,vite,html,css,tailwind,php,laravel,mysql,postgres,sqlite,prisma,git,github,docker" />
</p>

## Tecnologías de escritorio
<p align="left">
  <img src="https://skillicons.dev/icons?i=electron,tauri,flutter,dart,cs,dotnet,java,python,qt,kotlin,go" />
</p>
<b>Windows</b>: WPF · WinForms · .NET MAUI  
<b>Cross‑platform</b>: Electron · Tauri · Flutter  
<b>Nativo</b>: Qt · JavaFX  
<b>Packaging</b>: NSIS · MSI · auto‑update
...
## Tech Highlights
- Multi‑tenant: aislamiento por tenants, seguridad y escalabilidad.
- Arquitectura limpia: módulos desacoplados y código mantenible.
- CI/CD: pipelines con pruebas, coverage y releases automatizados.
- Rendimiento: caching, lazy‑loading y code‑splitting en frontend.
- Observabilidad: logs estructurados y métricas clave.

## Roadmap 2026
- Publicar plantilla fullstack multi‑tenant abierta.
- Lanzar app de escritorio con Tauri + React.
- Integrar autenticación robusta con roles y auditoría.
